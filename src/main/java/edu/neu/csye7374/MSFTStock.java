...
public class MSFTStock extends StockAPI {
    private static final double BID_FACTOR = 1.10;
    private static final int RECENT_BID_COUNT = 6;

    public MSFTStock(double price) {
        super("Microsoft", price, "Microsoft Common Stock");
    }
